          ...
          >
            ...
            <div>
              <ul className="custom-list">
                <li>
                  {" "}
                  Refunds will be provided for ticket cancellations made up to
                  14 days before the event date. After this period, no refunds
                ...
                <li>
                  ...
                  mobile device for entry to the event.{" "}
                </li>

                <li>
                  {" "}
                  Each individual is allowed to purchase a maximum of 2 tickets
                  for this event to ensure fair distribution.{" "}
                </li>

                <li>
                  {" "}
                  In the rare event of cancellation or postponement, attendees
                  will be notified via email. Refunds will be automatically
                  processed for canceled events.{" "}
                </li>

                <li>
                  {" "}
                  Tickets for postponed events will not be refunded and the
                  ticket will be considered a valid ticket on the date of
                  postponement.
                </li>
