...
def mine_block():
    ...
    blockchain.add_transaction(sender= node_address, receiver= 'You', amount=15)
...
blockchain = [
    {"index": 1, "transactions": [], "previous_hash": "0"},
    {"index": 2, "transactions": [{"sender": "Alice", "receiver": "Bob", "amount": 50}], "previous_hash": "abc123"},
]
...
@app.route('/add_transaction', methods=['POST'])
def add_transaction():
    """API to add a transaction to the latest block"""
    ...
    blockchain[-1]["transactions"].append(data)
    
    return jsonify({"message": "Transaction added successfully!", "block": blockchain[-1]}), 201
